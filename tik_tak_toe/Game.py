...
class TicTacToe:
    def __init__(self):
        ...
        self.current_winner = Name # keep track of winner
    ...
    def make_move(self, square, letter):
        ...
        if self.board[square] == ' ':
            ...
            if self.current_winner(square, letter):
                self.current_winner = letter
            return True
        return False

    def winner(self, square, letter):
        # winner if 3 in a row anywhere, we have to check all the time
...
def play(game, x_player, o_player, print_game=True):
    # return the winner of the game(the letter of the winner) or None for tie
    if print_game:
    ...
    while game.empty_squares():
        ...
        # time break to make things a little easier to read
        time.sleep(0.5)
